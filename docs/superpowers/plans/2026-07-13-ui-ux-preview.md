...
- [ ] **Step 3: Implement the pure directory utilities**
...
- [ ] **Step 5: Replace the imperative mobile menu**
...
- [ ] **Step 6: Give the document a semantic, metadata-aware shell**
...
- [ ] **Step 7: Restore visible keyboard focus and drawer styles**
...
- [ ] **Step 1: Connect the tested directory model**
...
- [ ] **Step 2: Replace the oversized card layout**
...
- [ ] **Step 3: Add accessible discovery controls**
...
- [ ] **Step 4: Update the loading skeleton to match**
...
- [ ] **Step 1: Build a clear tournament hero**
...
- [ ] **Step 2: Recompose existing data into scannable sections**
...
- [ ] **Step 3: Remove non-semantic and unstable behavior**
...
- [ ] **Step 1: Strengthen the match summary**
...
- [ ] **Step 2: Improve mobile innings navigation**
...
- [ ] **Step 3: Update client-side metadata safely**
...
- [ ] **Step 4: Verify the scorecard with stored data**
...
- [ ] **Step 5: Commit the Match Centre preview**
...
- [ ] **Step 2: Start the production preview locally**
...
- [ ] **Step 3: Test the user journeys in a real browser**
...
- [ ] **Step 4: Start a temporary Cloudflare Quick Tunnel**
